...
class NdArrayTensorizer(Tensorizer):
  """Converts a sequence of actions to a batched FloatTensor."""
...
class ToTensor:
  ...
  MAP = {
      ...
      SequenceType.ACTION: NdArrayTensorizer,
      SequenceType.STATE: NdArrayTensorizer,
  }
